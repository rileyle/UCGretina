...
// ********************************************************************
//
#ifndef NuclearDecayChannel_h
#define NuclearDecayChannel_h 1
...
#include "GeneralPhaseSpaceDecay.hh"
...
class G4NuclearDecayChannel : public G4GeneralPhaseSpaceDecay
{
  // class description 
  //
  //  G4NuclearDecayChannel is a derived class from GeneralPhaseSpaceDecay,
...
public: // with description
  ...
  G4NuclearDecayChannel (const G4RadioactiveDecayMode &theMode, G4int Verbose,
			 const G4ParticleDefinition *theParentNucleus,
                         G4double theBR, G4double theQtransition, G4int A,
                         G4int Z, G4double theDaughterExcitation,
			 const G4String theDaughterName1,AngularDistribution theAngularDistribution);
