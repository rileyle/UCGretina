...
//
//
//$Id: GeneralPhaseSpaceDecay.hh,v 1.1 1997/05/21
// ----------------------------------------------------------------
...
// ----------------------------------------------------------------
#ifndef GeneralPhaseSpaceDecay_h
#define GeneralPhaseSpaceDecay_h 1
...
class G4GeneralPhaseSpaceDecay : public G4VDecayChannel
{
  public:
    //Constructors 
      ...
      G4GeneralPhaseSpaceDecay(AngularDistribution theAngularDistribution,G4int Verbose = 1);
