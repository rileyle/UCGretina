...
#include "PolarizedGammaTransition.hh"
#include "G4Pow.hh"
...
G4PhotonEvaporation::EmittedFragment(G4Fragment* nucleus)
{
  ...
  /* Do this once in Outgoing_Beam::setDecayProperties()
  ...
  // Uses the PhotonEvaporation data file if a local file doesn't exist.
  //  fNuclearLevelData->AddPrivateData(Z, A, fname);
  */
